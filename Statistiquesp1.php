...
foreach($listepub as $row){
    ...
    $nbthtot=$nbth1+$nbth2+$nbth3;
    $per1=($nbth1/$nbthtot)*100;
    $per2=($nbth2/$nbthtot)*100;
    $per3=($nbth3/$nbthtot)*100;
    ?>
    ...
    <header class="site-navbar" role="banner">
      ...
      <div></div>
          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            <li><a href="homepage.html"><h2>Déconnexion</h2></a>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div >
          ...
          <div >
            ...
            <form action="#" method="post">
              ...
              <div><h2> <?php
              echo "High priority Themes: ".$per1."%"; ?></h2></div>
              <div><h2> <?php
              echo "Medium priority Themes: ".$per2."%"; ?></h2></div>
              <div><h2> <?php
              echo "Low priority Themes: ".$per3."%"; ?></h2></div>
            </form>
          </div>

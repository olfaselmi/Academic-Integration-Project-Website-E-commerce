<!DOCTYPE html>
	...
	<head>
			  ...
			  <header id="header" id="home">
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
			    		<a href="homepage.html"><img src="img/logo.png" alt="" title="" /></a>		
     ...
     <input type="SUBMIT" value="Chercher" style="background-color: #47abd5;"> <br>
	 <a href="tri1.php">tri par date</a><br> </form>


                                <?PHP
                                include '../core/livraisonC.php';
                                    $cmd1 = new livraisonC;
                    $cmd=$cmd1->afficherlivraisons();
                                ?>
                                <?PHP
                                foreach($cmd as $row){
                            ?>
                            ...
                            <div> <label class="h5">Date Livraison : </label> <label class="h5 mb-3 text-black"><?php echo $row['date']; ?></label> </div>

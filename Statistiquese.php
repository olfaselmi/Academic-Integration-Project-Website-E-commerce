...
foreach($listeevent as $row){
    ...
    $nbpackstot=$nbpacks1+$nbpacks2+$nbpacks3;
    $per1=($nbpacks1/$nbpackstot)*100;
    $per2=($nbpacks2/$nbpackstot)*100;
    $per3=($nbpacks3/$nbpackstot)*100;
    ?>
        ...
        <div >
          ...
          <div >
            ...
            <form action="#" method="post">
              ...
              <div><h2> <?php
              echo "Low quantity order: ".$per1."%"; ?></h2></div>
              <div><h2> <?php
              echo "Medium quantity order: ".$per2."%"; ?></h2></div>
              <div><h2> <?php
              echo "High quantity order: ".$per3."%"; ?></h2></div>
            </form>
          </div>
